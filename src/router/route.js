...
//     path: "/",
//     name: "slotA2",
//     component: () => import("@/views/slot1A/p-start.vue"),
//   },
 
//   {
//     path: "/home",
//     name: "slotAA",
//     component: () => import("@/views/slot1A/p-home.vue"),
//   },
...
export const routes = [
  {
    path: "/",
    name: "list",
    component: () => import("@/views/games/p-list.vue"),
  },

  {
    path: "/home",
    name: "detail",
    component: () => import("@/views/games/p-detail.vue"),
  },
